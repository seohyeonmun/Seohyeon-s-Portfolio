  ...
  return (
    <section className="min-h-[90svh] relative flex items-center pt-[72px] bg-white text-black overflow-hidden" id="intro">
      <div className="max-w-[var(--spacing-container-max)] w-full mx-auto px-gutter relative z-10 h-full flex flex-col justify-center">
        ...
        <div className="absolute -right-8 md:-right-16 lg:-right-32 bottom-0 top-0 w-[150%] md:w-[85%] lg:w-[75%] z-0 flex items-end justify-end pointer-events-none">
          <img
            alt="문서현 개발자 프로필 사진"
        ...
        <div className="space-y-8 max-w-xl lg:max-w-2xl relative z-10 my-20 md:ml-10 lg:ml-20">
          <div>
